 ...
 */
@Component
public class DynamicJob implements ScxSimpleJobProcessor, Job {
    ...
    public void execute(JobExecutionContext executorContext) throws JobExecutionException {
       ...
       /* String jarPath = map.getString("jarPath");
        ...
        //try {
        //    SimpleJobContext simpleJobContext = SimpleJobContext.class.newInstance();
        //    com.alibaba.dts.common.domain.store.Job job = new com.alibaba.dts.common.domain.store.Job();
        //    job.setJobArguments("aaa");
        //    simpleJobContext.setJob(job);
        //    process(simpleJobContext);
        //} catch (Exception e) {
        //    e.printStackTrace();
        //}
    }
    ...
    public ProcessResult process(ScxSimpleJobContext simpleJobContext) {
        ...
        return new com.alibaba.edas.schedulerx.ProcessResult(true);
    }
}
